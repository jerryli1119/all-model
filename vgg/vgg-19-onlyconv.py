...
weights ={  
    ...
    'wc17':tf.Variable(tf.random_normal([3,3,32,32])),  
    'wc18':tf.Variable(tf.random_normal([3,3,32,32])),
    'wc19':tf.Variable(tf.random_normal([3,3,32,32])), 
...
biases ={  
    ...
    'bc17':tf.Variable(tf.constant(value=0.0001,shape=[32])),  
    'bc18':tf.Variable(tf.constant(value=0.0001,shape=[32])),  
    'bc19':tf.Variable(tf.constant(value=0.0001,shape=[32])),  
