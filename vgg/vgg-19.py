...
weights ={  
    ...
    'wc3':tf.Variable(tf.random_normal([3,3,32,128])),  
    'wc4':tf.Variable(tf.random_normal([3,3,128,128])),  
      
    'wc5':tf.Variable(tf.random_normal([3,3,128,512])),  
    'wc6':tf.Variable(tf.random_normal([3,3,512,512])),  
    'wc7':tf.Variable(tf.random_normal([3,3,512,512])),  
    'wc8':tf.Variable(tf.random_normal([3,3,512,512])),  
    ...
    'wc12':tf.Variable(tf.random_normal([3,3,512,2048])),  
    'wc13':tf.Variable(tf.random_normal([3,3,2048,2048])),  
    'wc14':tf.Variable(tf.random_normal([3,3,2048,2048])),  
    'wc15':tf.Variable(tf.random_normal([3,3,2048,2048])),  
    'wc16':tf.Variable(tf.random_normal([3,3,2048,2048])),
    'wc17':tf.Variable(tf.random_normal([3,3,2048,2048])),  
    'wc18':tf.Variable(tf.random_normal([3,3,2048,2048])),  
    'wc19':tf.Variable(tf.random_normal([3,3,2048,2048])),
...
biases ={  
    ...
    'bc17':tf.Variable(tf.constant(value=0.0001,shape=[2048])),  
    'bc18':tf.Variable(tf.constant(value=0.0001,shape=[2048])),  
    'bc19':tf.Variable(tf.constant(value=0.0001,shape=[2048])),  
...
def main(iternum,gpu_size):
  ...
  learning_rate = 0.001
  batch_size = 16
  #test gpu usage 			0.75		- 16	- 8735
  #test swap gpu usage 	0.7			- 16	- 8027
  #test swap gpu usage 	0.65		- 16	- 7619
  #test swap gpu usage 	0.58		- 16	- 6947
  #test swap gpu usage 	0.542		- 16	- 6411
  #test swap gpu usage 	0.527		- 16	- 6245

  #batch usage 0.7
  #non swap batch	- 14(0.73)
  #swap			batch -	30
